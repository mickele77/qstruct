...
*/
#ifndef SECTIONSTEELI_H
#define SECTIONSTEELI_H
...
class EXPORT_SECTION_LIB_OPT SectionSteelI : public SectionSteelProfile {
public:
    SectionSteelI(DoublePlus **p, Steel * st, UnitMeasure *ump);
    ~SectionSteelI();
