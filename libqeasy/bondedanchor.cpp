...
void BondedAnchor::initVar() {
    ...
    lVEd->setToolTip(tr("Braccio di applicazione della Componente trasversale agente sull'ancoraggio"));
    lVEd->setRichName( tr("l<span style=\"vertical-align:sub;\">VEd</span>") );
    addVarToContainer( lVEd );

    VEdX = new DoublePlus( 0.0, "VEdX", m_unitMeasure, UnitMeasure::loadF, false );
    VEdX->setToolTip(tr("Componente trasversale agente lungo X sull'ancoraggio"));
    VEdX->setRichName( tr("V<span style=\"vertical-align:sub;\">Ed,x</span>") );
    addVarToContainer( VEdX );

    VEdY = new DoublePlus( 0.0, "VEdX", m_unitMeasure, UnitMeasure::loadF, false );
    VEdY->setToolTip(tr("Componente trasversale agente lungo Y sull'ancoraggio"));
    VEdY->setRichName( tr("V<span style=\"vertical-align:sub;\">Ed,y</span>") );
    addVarToContainer( VEdY );

    TEd = new DoublePlus( 0.0, "TEd", m_unitMeasure, UnitMeasure::loadM, false );
    TEd->setToolTip(tr("Momento indotto dalla componente trasversale"));
    TEd->setRichName( tr("T<span style=\"vertical-align:sub;\">Ed</span>") );
    addVarToContainer( TEd );

    eNEdX = new DoublePlus( 0.0, "eNEdX", m_unitMeasure, UnitMeasure::sectL, false );
    eNEdX->setToolTip(tr("Eccentricità della componente di trazione lungo X"));
    eNEdX->setRichName( tr("e<span style=\"vertical-align:sub;\">NEd,x</span>") );
    addVarToContainer( eNEdX );

    eNEdY = new DoublePlus( 0.0, "eNEdY", m_unitMeasure, UnitMeasure::sectL, false );
    eNEdY->setToolTip(tr("Eccentricità della componente di trazione lungo Y"));
    eNEdY->setRichName( tr("e<span style=\"vertical-align:sub;\">NEd,y</span>") );
    addVarToContainer( eNEdY );

    NEd = new DoublePlus( 0.0, "NEd", m_unitMeasure, UnitMeasure::loadF, false );
    NEd->setToolTip(tr("Componente di trazione"));
    NEd->setRichName( tr("N<span style=\"vertical-align:sub;\">Ed</span>") );
    addVarToContainer( NEd );

    d = new DoublePlus( 1.6e-2, "d", m_unitMeasure, UnitMeasure::sectL, false );
    d->setToolTip(tr("Diametro barra acciaio"));
    d->setRichName( tr("d") );
    addVarToContainer( d );

    d0 = new DoublePlus( 2.0e-2, "d0", m_unitMeasure, UnitMeasure::sectL, false );
    d0->setToolTip(tr("Diametro foro"));
    d0->setRichName( tr("d<span style=\"vertical-align:sub;\">0</span>") );
    addVarToContainer( d0 );

    As = new DoublePlus( 157.0e-6, "As", m_unitMeasure, UnitMeasure::sectL2, false );
    As->setToolTip(tr("Area resistente barra acciaio"));
    As->setRichName( tr("A<span style=\"vertical-align:sub;\">s</span>") );
    ...
    fyks->setToolTip(tr("Valore caratteristico della tensione di snervamento dell'acciaio"));
    fyks->setRichName( tr("f<span style=\"vertical-align:sub;\">yk,s</span>") );
    addVarToContainer( fyks );

    fuks = new DoublePlus( 8.0e+8, "fuks", m_unitMeasure, UnitMeasure::tension, false );
    fuks->setToolTip(tr("Valore caratteristico della tensione di rottura dell'acciaio"));
    fuks->setRichName( tr("f<span style=\"vertical-align:sub;\">uk,s</span>") );
    addVarToContainer( fuks );

    fckCube = new DoublePlus( 2.5e+7, "fckCube", m_unitMeasure, UnitMeasure::tension, false );
    fckCube->setToolTip(tr("Valore caratteristico della rottura a compressione su provino cubico del calcestruzzo"));
    fckCube->setRichName( tr("f<span style=\"vertical-align:sub;\">ck,cube</span>") );
    addVarToContainer( fckCube );

    nX = new UIntPlus( 1, "nHor", false );
    nX->setRichName( tr("n<span style=\"vertical-align:sub;\">or</span>") );
    nX->setToolTip( tr("Numero di ancoraggi presenti orizzontalmente" ) );
    addVarToContainer( nX );

    nY = new UIntPlus( 1, "nVer", false );
    nY->setRichName( tr("n<span style=\"vertical-align:sub;\">ver</span>") );
    nY->setToolTip( tr("Numero di ancoraggi presenti verticalmente" ) );
    addVarToContainer( nY );

    nTot = new UIntPlus( 1, "nTot", true );
    nTot->setRichName( tr("n<span style=\"vertical-align:sub;\">tot</span>") );
    nTot->setToolTip( tr("Numero di ancoraggi presenti nel gruppo" ) );
    ...
    cXMinus->setRichName( tr("c<span style=\"vertical-align:sub;\">or,←</span>") );
    cXMinus->setToolTip( tr("Distanza orizzontale sinistra dal bordo" ) );
    addVarToContainer( cXMinus );

    sX = new DoublePlus( 2.0e-1, "sHor", m_unitMeasure, UnitMeasure::sectL, false );
    sX->setRichName( tr("s<span style=\"vertical-align:sub;\">or</span>") );
    sX->setToolTip( tr("Interasse orizzontale tra gli ancoraggi") );
    addVarToContainer( sX );

    cXPlus = new DoublePlus( 0.1, "cHorRight", m_unitMeasure, UnitMeasure::sectL, false );
    cXPlus->setRichName( tr("c<span style=\"vertical-align:sub;\">or,→</span>") );
    cXPlus->setToolTip( tr("Distanza orizzontale destra dal bordo" ) );
    addVarToContainer( cXPlus );

    cYMinus = new DoublePlus( 0.1, "cVerDown", m_unitMeasure, UnitMeasure::sectL, false );
    cYMinus->setRichName( tr("c<span style=\"vertical-align:sub;\">ver,↓</span>") );
    cYMinus->setToolTip( tr("Distanza verticale inferiore dal bordo" ) );
    addVarToContainer( cYMinus );

    sY = new DoublePlus( 0.15, "sVer", m_unitMeasure, UnitMeasure::sectL, false );
    sY->setRichName( tr("s<span style=\"vertical-align:sub;\">ver</span>") );
    sY->setToolTip( tr("Interasse verticale tra gli ancoraggi" ) );
    addVarToContainer( sY );

    cYPlus = new DoublePlus( 0.1, "sVerUp", m_unitMeasure, UnitMeasure::sectL, false );
    cYPlus->setRichName( tr("c<span style=\"vertical-align:sub;\">ver,↑</span>") );
    cYPlus->setToolTip( tr("Distanza verticale superiore dal bordo" ) );
    addVarToContainer( cYPlus );

    h = new DoublePlus( 3.0e-1, "h", m_unitMeasure, UnitMeasure::sectL, false );
    h->setToolTip(tr("Spessore del supporto in calcestruzzo"));
    h->setRichName( tr("h") );
    addVarToContainer( h );

    hEff = new DoublePlus( 1.0e-1, "hEff", m_unitMeasure, UnitMeasure::sectL, false );
    hEff->setToolTip(tr("Effettiva profondità di ancoraggio"));
    hEff->setRichName( tr("h<span style=\"vertical-align:sub;\">ef</span>") );
    addVarToContainer( hEff );

    hEffMin = new DoublePlus( 0.8e-1, "hEffMin", m_unitMeasure, UnitMeasure::sectL, false );
    hEffMin->setToolTip(tr("Profondità di ancoraggio minima"));
    hEffMin->setRichName( tr("h<span style=\"vertical-align:sub;\">ef,min</span>") );
    addVarToContainer( hEffMin );

    hEffMax = new DoublePlus( 2.0e-1, "hEffMax", m_unitMeasure, UnitMeasure::sectL, false );
    hEffMax->setToolTip(tr("Profondità di ancoraggio massima"));
    hEffMax->setRichName( tr("h<span style=\"vertical-align:sub;\">ef,max</span>") );
    addVarToContainer( hEffMax );

    hMin = new DoublePlus( 0.8e-1, "hMin", m_unitMeasure, UnitMeasure::sectL, false );
    hMin->setToolTip(tr("Spessore minimo del supporto"));
    hMin->setRichName( tr("h<span style=\"vertical-align:sub;\">min</span>") );
    addVarToContainer( hMin );

    sMin = new DoublePlus( 1.0e-1, "sMin", m_unitMeasure, UnitMeasure::sectL, false );
    sMin->setToolTip(tr("Interasse minimo ancoraggi"));
    sMin->setRichName( tr("s<span style=\"vertical-align:sub;\">min</span>") );
    addVarToContainer( sMin );

    cMin = new DoublePlus( 1.0e-1, "cMin", m_unitMeasure, UnitMeasure::sectL, false );
    cMin->setToolTip(tr("Distanza minima dal bordo degli ancoraggi"));
    cMin->setRichName( tr("c<span style=\"vertical-align:sub;\">min</span>") );
    addVarToContainer( cMin );

    tauRkCr = new DoublePlus( 0.0, "tauRkCr", m_unitMeasure, UnitMeasure::tension, false );
    tauRkCr->setToolTip(tr("Tensione caratteristica calcestruzzo fessurato"));
    tauRkCr->setRichName( tr("τ<span style=\"vertical-align:sub;\">Rk,cr</span>") );
    addVarToContainer( tauRkCr );

    tauRkUCr = new DoublePlus( 0.0, "tauRkUCr", m_unitMeasure, UnitMeasure::tension, false );
    tauRkUCr->setToolTip(tr("Tensione caratteristica calcestruzzo non fessurato"));
    tauRkUCr->setRichName( tr("τ<span style=\"vertical-align:sub;\">Rk,ucr</span>") );
    addVarToContainer( tauRkUCr );

    tauRkUCr25 = new DoublePlus( 0.0, "tauRkUCr25", m_unitMeasure, UnitMeasure::tension, false );
    tauRkUCr25->setToolTip(tr("Tensione caratteristica calcestruzzo C20/25 non fessurato"));
    tauRkUCr25->setRichName( tr("τ<span style=\"vertical-align:sub;\">Rk,ucr,C20/25</span>") );
    addVarToContainer( tauRkUCr25 );

    concreteCrack = new BAnchorConcrete( BondedAnchor::Cracked, "concreteCrack", false );
    concreteCrack->setToolTip(tr("Condizioni di fessurazione del supporto in calcestruzzo"));
    concreteCrack->setRichName( tr("Fessurazione") );
    ...
    internalReinforcement->setToolTip(tr("Presenza di armatura rada (Ø>10mm e spaziatura a≥150mm o Ø≤10mm e spaziatura a≥100mm) o fitta"));
    internalReinforcement->setRichName( tr("Armatura interna") );
    ...
    edgeReinforcement->setToolTip(tr("Armatura nello spigolo (armatura assente, armatura Ø≥12mm presente, armatura Ø≥12mm presente con staffatura  fitta a≤100mm )"));
    edgeReinforcement->setRichName( tr("Armatura spigolo") );
    addVarToContainer( edgeReinforcement );

    NRks = new DoublePlus( 0.0, "NRks", m_unitMeasure, UnitMeasure::loadF, false );
    NRks->setToolTip(tr("Valore caratteristico della resistenza a trazione dell'ancoraggio in caso di rottura dell'acciaio"));
    NRks->setRichName( tr("N<span style=\"vertical-align:sub;\">Rk,s</span>") );
    ...
    gammaMsN->setToolTip(tr("Coefficiente sicurezza rottura acciaio - Trazione"));
    gammaMsN->setRichName( tr("γ<span style=\"vertical-align:sub;\">Ms,N</span>") );
    ...
    NhRds->setToolTip(tr("Valore di progetto della resistenza a trazione del singolo ancoraggio in caso di rottura dell'acciaio"));
    NhRds->setRichName( tr("N<span style=\"vertical-align:super;\">h</span><span style=\"vertical-align:sub;\">Rd,s</span>") );
    ...
    sCrNp->setToolTip(tr("Interasse"));
    sCrNp->setRichName( tr("s<span style=\"vertical-align:sub;\">cr,Np</span>") );
    ...
    cCrNp->setToolTip(tr("Distanza dal bordo"));
    cCrNp->setRichName( tr("c<span style=\"vertical-align:sub;\">cr,Np</span>") );
    ...
    ApN->setToolTip(tr("Area di influenza effettiva"));
    ApN->setRichName( tr("A<span style=\"vertical-align:sub;\">p,N</span>") );
    ...
    A0pN->setToolTip(tr("Area di influenza massima ancoraggio singolo"));
    A0pN->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">p,N</span>") );
    ...
    psiSNp->setRichName( tr("ψ<span style=\"vertical-align:sub;\">s,Np</span>") );
    ...
    psiGNp->setRichName( tr("ψ<span style=\"vertical-align:sub;\">g,Np</span>") );
    ...
    psiEcNpX->setRichName( tr("ψ<span style=\"vertical-align:sub;\">ec,Np,x</span>") );
    ...
    psiEcNpY->setRichName( tr("ψ<span style=\"vertical-align:sub;\">ec,Np,y</span>") );
    ...
    psiReNp->setRichName( tr("ψ<span style=\"vertical-align:sub;\">re,Np</span>") );
    ...
    N0Rkp->setToolTip(tr("Valore caratteristico massimo della resistenza in caso di rottura composta per pull-out e cono di calcestruzzo, riferito ad ancoraggio singolo - Trazione"));
    N0Rkp->setRichName( tr("N<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,p</span>") );
    ...
    NRkp->setToolTip(tr("Valore caratteristico della resistenza dell'ancoraggio in caso di rottura composta per pull-out e cono di calcestruzzo - Trazione"));
    NRkp->setRichName( tr("N<span style=\"vertical-align:sub;\">Rk,p</span>") );
    ...
    gammaC->setToolTip(tr("Coefficiente sicurezza rottura calcestruzzo"));
    ...
    gamma2->setToolTip(tr("Coefficiente sicurezza installazione"));
    gamma2->setRichName( tr("γ<span style=\"vertical-align:sub;\">2</span>") );
    addVarToContainer( gamma2 );

    gammaMpN = new DoublePlus( 1.0, "gammaMpN", m_unitMeasure, UnitMeasure::noDimension, true );
    gammaMpN->setToolTip(tr("Coefficiente sicurezza rottura per pull-out e cono di cls - Trazione"));
    gammaMpN->setRichName( tr("γ<span style=\"vertical-align:sub;\">Mp,N</span>") );
    ...
    NgRdp->setToolTip(tr("Valore di progetto della resistenza del gruppo di ancoraggi in caso di rottura composta per pull-out e cono di calcestruzzo - Trazione"));
    NgRdp->setRichName( tr("N<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,p</span>") );
    ...
    sCrN->setToolTip(tr("Interasse - Trazione"));
    sCrN->setRichName( tr("s<span style=\"vertical-align:sub;\">cr,N</span>") );
    ...
    cCrN->setToolTip(tr("Distanza dal bordo - Trazione"));
    cCrN->setRichName( tr("c<span style=\"vertical-align:sub;\">cr,N</span>") );
    ...
    AcN->setToolTip(tr("Area di influenza effettiva - Trazione"));
    AcN->setRichName( tr("A<span style=\"vertical-align:sub;\">c,N</span>") );
    ...
    A0cN->setToolTip(tr("Area di influenza massima ancoraggio singolo - Trazione"));
    A0cN->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">c,N</span>") );
    ...
    psiSN->setRichName( tr("ψ<span style=\"vertical-align:sub;\">s,N</span>") );
    ...
    psiEcNX->setRichName( tr("ψ<span style=\"vertical-align:sub;\">ec,N,x</span>") );
    ...
    psiEcNY->setRichName( tr("ψ<span style=\"vertical-align:sub;\">ec,N,y</span>") );
    ...
    psiReN->setRichName( tr("ψ<span style=\"vertical-align:sub;\">re,N</span>") );
    ...
    N0Rkc->setToolTip(tr("Valore caratteristico massimo della resistenza in caso di rottura del cono di calcestruzzo riferito ad ancoraggio singolo - Trazione"));
    N0Rkc->setRichName( tr("N<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,c</span>") );
    ...
    NRkc->setToolTip(tr("Valore caratteristico della resistenza dell'ancoraggio in caso di rottura del cono di calcestruzzo - Trazione"));
    NRkc->setRichName( tr("N<span style=\"vertical-align:sub;\">Rk,c</span>") );
    ...
    gammaMcN->setToolTip(tr("Coefficiente sicurezza rottura cono di cls - Carico assiale"));
    gammaMcN->setRichName( tr("γ<span style=\"vertical-align:sub;\">Mc,N</span>") );
    ...
    NgRdc->setToolTip(tr("Valore di progetto della resistenza del gruppo di ancoraggi in caso di rottura del cono di calcestruzzo - Trazione"));
    NgRdc->setRichName( tr("N<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,c</span>") );
    ...
    ratioCCrSpOvEff->setToolTip(tr("Rapporto tra cCrSp e l'altezza dell'ancoraggio"));
    ratioCCrSpOvEff->setRichName( tr("c<span style=\"vertical-align:sub;\">cr,sp</span>/h<span style=\"vertical-align:sub;\">ef</span>") );
    ...
    ratioSCrSpOvEff->setToolTip(tr("Rapporto tra sCrSp e l'altezza dell'ancoraggio"));
    ratioSCrSpOvEff->setRichName( tr("s<span style=\"vertical-align:sub;\">cr,sp</span>/h<span style=\"vertical-align:sub;\">ef</span>") );
    addVarToContainer( ratioSCrSpOvEff );

    sCrSp = new DoublePlus( 1.0e-1, "sCrSp", m_unitMeasure, UnitMeasure::sectL, false );
    sCrSp->setToolTip(tr("Interasse - Trazione"));
    sCrSp->setRichName( tr("s<span style=\"vertical-align:sub;\">cr,sp</span>") );
    ...
    cCrSp->setToolTip(tr("Distanza dal bordo - Trazione"));
    cCrSp->setRichName( tr("c<span style=\"vertical-align:sub;\">cr,sp</span>") );
    ...
    psiHSp->setRichName( tr("ψ<span style=\"vertical-align:sub;\">h,sp</span>") );
    ...
    NRkSp->setToolTip(tr("Valore caratteristico della resistenza dell'ancoraggio in caso di rottura per splitting - Trazione"));
    NRkSp->setRichName( tr("N<span style=\"vertical-align:sub;\">Rk,sp</span>") );
    ...
    gammaMSpN->setToolTip(tr("Coefficiente sicurezza rottura per splittings - Carico assiale"));
    gammaMSpN->setRichName( tr("γ<span style=\"vertical-align:sub;\">Msp,N</span>") );
    ...
    NgRdSp->setToolTip(tr("Valore di progetto della resistenza del gruppo di ancoraggi in caso di rottura composta per pull-out e cono di calcestruzzo - Trazione"));
    NgRdSp->setRichName( tr("N<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,sp</span>") );
    ...
    M0Rks->setToolTip(tr("Momento resistente dell'ancoraggio in acciaio - Taglio"));
    M0Rks->setRichName( tr("M<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,s</span>") );
    addVarToContainer( M0Rks );

    MRks = new DoublePlus( 0.0, "MRks", m_unitMeasure, UnitMeasure::loadM, true );
    MRks->setToolTip(tr("Momento resistente dell'ancoraggio in acciaio - Taglio"));
    MRks->setRichName( tr("M<span style=\"vertical-align:sub;\">Rk,s</span>") );
    ...
    alphaM->setToolTip(tr("Coefficiente per tener conto del grado di incastro dell'ancoraggio in caso di rottura dell'acciaio - Taglio"));
    alphaM->setRichName( tr("α<span style=\"vertical-align:sub;\">M</span>") );
    addVarToContainer( alphaM );

    VRks = new DoublePlus( 0.0, "VRks", m_unitMeasure, UnitMeasure::loadF, false );
    VRks->setToolTip(tr("Valore caratteristico della resistenza a taglio dell'ancoraggio in caso di rottura dell'acciaio - Taglio"));
    VRks->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,s</span>") );
    ...
    gammaMsV->setToolTip(tr("Coefficiente sicurezza rottura acciaio - Taglio"));
    gammaMsV->setRichName( tr("γ<span style=\"vertical-align:sub;\">Ms,V</span>") );
    ...
    VhRds->setToolTip(tr("Valore di progetto della resistenza a taglio del singolo ancoraggio in caso di rottura dell'acciaio - Taglio"));
    VhRds->setRichName( tr("V<span style=\"vertical-align:super;\">h</span><span style=\"vertical-align:sub;\">Rd,s</span>") );
    ...
    kCp->setToolTip(tr("Coefficiente k necessario per calcolo rottura per pry-out - Taglio"));
    kCp->setRichName( tr("k") );
    ...
    VRkCp->setToolTip(tr("Valore caratteristico della resistenza dell'ancoraggio in caso di rottura per pry-out - Taglio"));
    VRkCp->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,cp</span>") );
    ...
    gammaMcV->setToolTip(tr("Coefficiente sicurezza rottura bordo e pry-out - Taglio"));
    gammaMcV->setRichName( tr("γ<span style=\"vertical-align:sub;\">Mc,V</span>") );
    ...
    VgRdCp->setToolTip(tr("Valore di progetto della resistenza a taglio del gruppo di ancoraggi in caso di rottura per pry-out - Taglio"));
    VgRdCp->setRichName( tr("V<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,cp</span>") );
    ...
    k1C->setToolTip(tr("Coefficiente k1 necessario per calcolo rottura bordo - Taglio"));
    k1C->setRichName( tr("k<span style=\"vertical-align:sub;\">1</span>") );
    ...
    A0CVXPlus->setToolTip(tr("Area di influenza massima per calcolo rottura bordo - Taglio X+"));
    A0CVXPlus->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">c,VX+</span>") );
    ...
    ACVXPlus->setToolTip(tr("Area di influenza effettiva per calcolo rottura bordo - Taglio X+"));
    ACVXPlus->setRichName( tr("A<span style=\"vertical-align:sub;\">c,VX+</span>") );
    ...
    V0RkCXPlus->setToolTip(tr("Valore caratteristico di riferimento della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X+"));
    V0RkCXPlus->setRichName( tr("V<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,cX+</span>") );
    ...
    VRkCXPlus->setToolTip(tr("Valore caratteristico della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X+"));
    VRkCXPlus->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,cX+</span>") );
    ...
    VgRdCXPlus->setToolTip(tr("Valore caratteristico della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X+"));
    VgRdCXPlus->setRichName( tr("V<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,cX+</span>") );
    ...
    A0CVXMinus->setToolTip(tr("Area di influenza massima per calcolo rottura bordo - Taglio X-"));
    A0CVXMinus->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">c,VX-</span>") );
    ...
    ACVXMinus->setToolTip(tr("Area di influenza effettiva per calcolo rottura bordo - Taglio X-"));
    ACVXMinus->setRichName( tr("A<span style=\"vertical-align:sub;\">c,VX-</span>") );
    ...
    V0RkCXMinus->setToolTip(tr("Valore caratteristico di riferimento della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X-"));
    V0RkCXMinus->setRichName( tr("V<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,cX-</span>") );
    ...
    VRkCXMinus->setToolTip(tr("Valore caratteristico della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X-"));
    VRkCXMinus->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,cX-</span>") );
    ...
    VgRdCXMinus->setToolTip(tr("Valore di progetto della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio X-"));
    VgRdCXMinus->setRichName( tr("V<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,cX-</span>") );
    ...
    A0CVYPlus->setToolTip(tr("Area di influenza massima per calcolo rottura bordo - Taglio Y+"));
    A0CVYPlus->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">c,VY+</span>") );
    ...
    ACVYPlus->setToolTip(tr("Area di influenza effettiva per calcolo rottura bordo - Taglio Y+"));
    ACVYPlus->setRichName( tr("A<span style=\"vertical-align:sub;\">c,VY+</span>") );
    ...
    V0RkCYPlus->setToolTip(tr("Valore caratteristico di riferimento della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y+"));
    V0RkCYPlus->setRichName( tr("V<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,cY+</span>") );
    ...
    VRkCYPlus->setToolTip(tr("Valore caratteristico della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y+"));
    VRkCYPlus->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,cY+</span>") );
    ...
    VgRdCYPlus->setToolTip(tr("Valore di progetto della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y+"));
    VgRdCYPlus->setRichName( tr("V<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,cY+</span>") );
    ...
    A0CVYMinus->setToolTip(tr("Area di influenza massima per calcolo rottura bordo - Taglio Y-"));
    A0CVYMinus->setRichName( tr("A<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">c,VY-</span>") );
    ...
    ACVYMinus->setToolTip(tr("Area di influenza effettiva per calcolo rottura bordo - Taglio Y-"));
    ACVYMinus->setRichName( tr("A<span style=\"vertical-align:sub;\">c,VY-</span>") );
    ...
    V0RkCYMinus->setToolTip(tr("Valore caratteristico di riferimento della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y-"));
    V0RkCYMinus->setRichName( tr("V<span style=\"vertical-align:super;\">0</span><span style=\"vertical-align:sub;\">Rk,cY-</span>") );
    ...
    VRkCYMinus->setToolTip(tr("Valore caratteristico della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y-"));
    VRkCYMinus->setRichName( tr("V<span style=\"vertical-align:sub;\">Rk,cY-</span>") );
    ...
    VgRdCYMinus->setToolTip(tr("Valore di progetto della resistenza a taglio del gruppo di ancoraggi in caso di rottura del bordo - Taglio Y-"));
    VgRdCYMinus->setRichName( tr("V<span style=\"vertical-align:super;\">g</span><span style=\"vertical-align:sub;\">Rd,cY-</span>") );
...
public:
    BAnchorConcretePrivate(BondedAnchor::Concrete v):
        value(v){
        enumList.append( BAnchorConcreteEnumVal( BondedAnchor::Cracked, "Cracked", tr("Fessurato")) );
        enumList.append( BAnchorConcreteEnumVal( BondedAnchor::NotCracked, "NotCracked", tr("Non fessurato")) );
    }
    int valueIndex(){
...
public:
    BAnchorInternalReinforcementPrivate(BondedAnchor::InternalReinforcement v):
        value(v){
        enumList.append( BAnchorInternalReinforcementEnumVal( BondedAnchor::Rare, "Rare", tr("Normale")) );
        enumList.append( BAnchorInternalReinforcementEnumVal( BondedAnchor::Dense, "Dense", tr("Fitta")) );
    }
    int valueIndex(){
        for( int i=0; i < enumList.size(); ++i){
            if( enumList.at(i).val == value ){
...
public:
    BAnchorEdgeReinforcementPrivate(BondedAnchor::EdgeReinforcement v):
        value(v){
        enumList.append( BAnchorEdgeReinforcementEnumVal( BondedAnchor::EdgeNotReinforced, "NotReinforced", tr("Nessun rinforzo")) );
        enumList.append( BAnchorEdgeReinforcementEnumVal( BondedAnchor::EdgeReinforced, "Reinforced", tr("Spigolo rinforzato")) );
        enumList.append( BAnchorEdgeReinforcementEnumVal( BondedAnchor::EdgeReinforcedStirrups, "ReinforcedStirrups", tr("Spigolo rinforzato - staffatura fitta")) );
    }
    int valueIndex(){
        for( int i=0; i < enumList.size(); ++i){
            if( enumList.at(i).val == value ){
